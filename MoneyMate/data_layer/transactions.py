...
from .contacts import contact_exists
...
# --- CRUD TRANSACTIONS ---
def add_transaction(contact_id, type_, amount, date, description=""):
    """
...
def get_transactions(contact_id=None):
    """
...
def get_contact_balance(contact_id):
    """
